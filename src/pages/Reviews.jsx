...
export default function Reviews() {   
  ...
  return (     
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem", width: "100%", boxSizing: "border-box" }}>              
      ...
      {/* Analytics Aggregate Scoreboard Tiles */}       
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10, width: "100%" }}>         
        {filteredReviews.length > 0 ? (           
          filteredReviews.map((rev) => (             
            <div key={rev.id} className="floating-glass" style={{ background: "var(--surface)", borderRadius: "14px", padding: "16px", display: "flex", flexDirection: "column", gap: 12, width: "100%", boxSizing: "border-box", overflow: "hidden" }}>                              
              
              {/* HEADER LAYOUT: Stacks beautifully into a natural column list map on small screen profiles */}               
              <div style={{ 
                display: "flex", 
                justifyContent: "space-between", 
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 4, width: "100%" }}>                   
                  ...
                  <span style={{                      
                    ...
                    padding: "1px 6px", borderRadius: "4px", width: "fit-content", fontWeight: 600                   
                  }}>                     
                    Verified Order: {rev.dish}                   
                  </span>                 
                </div>                                  
                
                {/* RIGHT SIDE META CONTAINER: Perfectly adapts Helpful Vote and Star Ratings direct side-by-side */}                 
                <div style={{ 
                  display: "flex", 
                  alignItems: "center", 
                  gap: "10px", 
                  ...
                  <div style={{ 
                    ...
                    <Heart size={11} color="var(--danger)" fill={rev.rating >= 4 ? "var(--danger)" : "none"} />                     
                    <span style={{ whiteSpace: "normal" }}>                       
                      {isMobile ? "Helpful" : "Helpful Student Vote"}                     
                    </span>                   
                  </div>                   
              ...
              <p style={{ fontSize: "0.82rem", color: "var(--text2)", lineHeight: 1.5, padding: "2px 0", fontWeight: 500, wordBreak: "break-word" }}>                 
                "{rev.comment}"               
              </p>               
